...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		this.background(230, 210, 211);
		
		// Select a map provider
		AbstractMapProvider provider = new Google.GoogleTerrainProvider();
		
		// Select a map2 provider
		AbstractMapProvider myProvider = new Microsoft.AerialProvider();
		...
		if (offline) {
			...
			myProvider = new MBTilesMapProvider(mbTilesString);
		...
		// Create a new UnfoldingMap to be displayed in this window.
		map2 = new UnfoldingMap(this, 400, 50, 350, 500, myProvider);
		
		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
		map2.zoomAndPanTo(zoomLevel, new Location(48.1021f, 11.2977f));
